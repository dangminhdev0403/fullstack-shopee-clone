...
const ChatBox = () => {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-end bg-gradient-to-br from-[#FFF3ED] via-[#FFE2D5] to-[#FFD4C2] p-4">
      <div className="flex h-[480px] w-full max-w-md flex-col overflow-hidden rounded-3xl bg-white/80 shadow-2xl ring-1 ring-black/5 backdrop-blur-xl">
        {/* HEADER Shopee */}
